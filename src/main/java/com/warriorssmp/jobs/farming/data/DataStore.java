package com.warriorssmp.jobs.farming.data;
...
public final class DataStore extends AbstractDataStore<PlayerGatherData> {
    ...
    public DataStore(FarmingPlugin plugin) {
    ...
    public void save(PlayerGatherData data) {
        ...
        try {
            ...
            plugin.getLogger().warning("Failed to save Farmer data for " + data.uuid + ": " + e.getMessage());
        }
    }
}
