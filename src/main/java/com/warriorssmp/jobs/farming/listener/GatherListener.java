package com.warriorssmp.jobs.farming.listener;
...
public final class GatherListener implements Listener {
    ...
    public GatherListener(FarmingPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onInteractMasterNpc(PlayerInteractEntityEvent event) {
        ...
        NamespacedKey npcKey = new NamespacedKey(plugin.host(), "master_farmer_npc");
