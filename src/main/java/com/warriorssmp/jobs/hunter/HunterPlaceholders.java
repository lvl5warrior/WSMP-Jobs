...
/**
 * Registers %hunter_level%, %hunter_xp%, %hunter_tier%, %hunter_streak%.
 * Useful for TAB / scoreboard integration alongside your other skill plugins.
 */
public final class HunterPlaceholders extends PlaceholderExpansion {

    private final HunterPlugin plugin;

    public HunterPlaceholders(HunterPlugin plugin) {
        this.plugin = plugin;
    }
