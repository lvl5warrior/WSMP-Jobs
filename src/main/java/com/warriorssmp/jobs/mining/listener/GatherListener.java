package com.warriorssmp.jobs.mining.listener;
...
public final class GatherListener implements Listener {
    ...
    public GatherListener(MiningPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onInteractMasterNpc(PlayerInteractEntityEvent event) {
        ...
        NamespacedKey npcKey = new NamespacedKey(plugin.host(), "master_miner_npc");
