package com.warriorssmp.jobs.mining.data;
...
public final class DataStore extends AbstractDataStore<PlayerGatherData> {
    ...
    public DataStore(MiningPlugin plugin) {
    ...
    public void save(PlayerGatherData data) {
        ...
        try {
            ...
            plugin.getLogger().warning("Failed to save Miner data for " + data.uuid + ": " + e.getMessage());
        }
    }
}
